...
public class PetService {
    ...
    public void listarPetsDoAbrigo() throws IOException, InterruptedException {
        ...
        HttpResponse<String> response = ClientHttpConfiguration.requestGET("http://localhost:8080/abrigos/" +idOuNome +"/pets");
    ...
    public void importarPetsDoAbrigo() throws IOException, InterruptedException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            HttpResponse<String> response = ClientHttpConfiguration.requestPost("http://localhost:8080/abrigos/" + idOuNome + "/pets", json);
